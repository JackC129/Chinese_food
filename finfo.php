...
<h2>Info Table</h2>
<h4>Below is a table that includes the name of each food in the SQL database, which cuisine it's from, and the specific location this dish was made in.</h4>
...
<table>
    ...
    $sql = "SELECT `Food`, `Cuisine`, `Spec Location` FROM `50chinesefood`";
